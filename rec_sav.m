...
// pass 2
	...
	tab->tab_len = bufix;
	tab->gr = (wt_group *)malloc(sizeof(wt_group) * n);
	tab->ngr = n;
...
dump_wt_tab(wt_tab *tab)
{
	...
	printf("ngr = %d, ntotal = %d\n", tab->ngr, tab->tab_len);

// buf is ok
//	for (i = 0; i < tab->nent; i++) {
//		et = tab->buf + i;
//		printf("entry[%d] = %d/%f\n", i, et->ix, et->w);
//	}
